...
export default function ExecutiveCoachingPage() {
    ...
    const fetchProgram = async () => {
        try {
            const docRef = doc(db, 'programs', 'executive');
        ...
        <>
            ...
            <section style={{
                ...
                <div style={{
                    position: 'absolute',
                    inset: 0,
                    background: 'radial-gradient(circle at 30% 50%, rgba(139,115,85,0.3) 0%, transparent 50%)',
                }} />
                    ...
                    <div style={{
                        ...
                        {program.details.map((item, idx) => (
                            <div key={idx} style={{
                                ...
                                onMouseEnter={(e) => {
                                    e.currentTarget.style.background = `linear-gradient(135deg, ${accentColor} 0%, #6b5d4f 100%)`;
                                ...
                                onMouseLeave={(e) => {
                                    e.currentTarget.style.background = 'linear-gradient(135deg, #f8f7f6 0%, #ffffff 100%)';
                ...
                <div className="container" style={{ maxWidth: '800px', margin: '0 auto' }}>
                    ...
                    <a
                        ...
                        style={{
                            ...
                            textDecoration: 'none',
                            transition: 'all 0.3s ease',
                            boxShadow: `0 8px 30px rgba(139,115,85,0.3)`
                        }}
                        onMouseEnter={(e) => {
                            e.currentTarget.style.transform = 'translateY(-4px)';
                            e.currentTarget.style.boxShadow = `0 12px 40px rgba(139,115,85,0.4)`;
                        }}
                        onMouseLeave={(e) => {
                            e.currentTarget.style.transform = 'translateY(0)';
                            e.currentTarget.style.boxShadow = `0 8px 30px rgba(139,115,85,0.3)`;
                        }}
                    >
